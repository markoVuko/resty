...
{
    public class EditSetScheduleValidator : AbstractValidator<CreateScheduleDto>
    {
        public EditSetScheduleValidator(RadContext con)
        {
            ...
            RuleFor(x => x.DateBegun)
                .NotNull()
                .WithMessage("Check in time can not be null!");
            RuleFor(x => x.ClockedOut)
                .NotNull()
                .WithMessage("Clocked out can not be null!");
